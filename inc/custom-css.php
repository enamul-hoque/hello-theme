...
class Custom_CSS_Support {
	...
	public function add_controls_section($element, $section_id, $args) {
		...
		if ($section_id == 'section_custom_css_pro') {
			...
			$element->start_controls_section(
				'section_custom_css',
				[
					'label' => esc_html__( 'Custom CSS', 'hello-elementor-child' ),
			...
			$element->add_control(
				'custom_css_title',
				[
					'raw' => esc_html__( 'Add your own custom CSS here', 'hello-elementor-child' ),
			...
			$element->add_control(
				...
				[
					'raw' => esc_html__( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'hello-elementor-child' ),
					'type' => Controls_Manager::RAW_HTML,
	...
	public function enqueue_editor_scripts() {
		// die();
		wp_enqueue_script('custom-css-support', get_stylesheet_directory_uri() . '/assets/js/custom-css-support.js', array('jquery'), '1.0.0', true);
	}
